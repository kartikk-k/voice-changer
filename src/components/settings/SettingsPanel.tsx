...
export function SettingsPanel({
  ...
  return (
    <div className="flex w-full lg:w-[480px] lg:sticky lg:top-6 shrink-0 flex-col gap-[14px] overflow-clip rounded-[20px] border border-border p-[8px] self-start lg:max-h-[923px]">
      {/* Title area */}
